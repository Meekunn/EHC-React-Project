    ...
    return (
        <>
            ...
            <div className='auth-wrapper'>
                <Snackbar focusValue={focusName} value={username} validValue={validName} info1={'4 to 24 characters.'} info2={'Only letters and underscores allowed.'} />
                <Snackbar focusValue={focusEmail} value={email} validValue={validEmail} info1={'Invalid Email'} />
                <Snackbar focusValue={focusPass} value={password} validValue={validPass} 
                    info1={'8 to 24 characters.'} 
                    info2={'Must include uppercase and lowercase letters, a number and a special character.'} 
                    info3={'Allowed Characters: !@#$%'}
                />
                <Snackbar focusValue={focusConfirmPass} value={confirmPass} validValue={validConfirmPass} 
                        ...
                        <div className='auth-form'>
                            <div className='input-group' >
                                <label htmlFor='username'> 
                                    ...
                                    <TiTimes className={validName || !username ? 'hide' : 'invalid'}/>
                                </label>
                            ...
                            <div className='input-group' >
                                <label htmlFor='email'> 
                                    ...
                                    <TiTimes className={validEmail || !email ? 'hide' : 'invalid'}/>
                                </label>
                                <div className='input-with-icon'>
                                    <input 
                                        required
                            ...
                            <div className='input-group' >
                                <label htmlFor='password'>
                                    ...
                                    <TiTimes className={validPass || !password ? 'hide' : 'invalid'}/>
                                </label>
                                <div className='input-with-icon'>
                                    <input
                                        required
                            ...
                            <div className='input-group'>
                                <label htmlFor='confirm'> 
                                    Confirm Password: 
                                    <FiCheckCircle className={validConfirmPass && confirmPass ? 'valid' : 'hide'}/> 
                                    <TiTimes className={validConfirmPass || !confirmPass ? 'hide' : 'invalid'}/>
                                </label>
                                <div className='input-with-icon'>
                                    <input
                                        required
                            ...
                            <button className='auth-btn' onClick={signUpEmail}
                                disabled={!validName || !validEmail || !validPass || !validConfirmPass ? true : false}
                            >
                                Sign Up
                            </button>
                        </div>
