        ...
        <div className={isMobile? 'sidenav-wrapper mobile' : 'sidenav-wrapper'}>
            <div className='sidenav-container'>
                ...
                <div className='sidenav-links'>
                    <button className='sidenav-btn' onClick={() => {router('/dashboard/school'); setIsMobile(false)}}>
                    <span
                        style={{
                    ...
                    <button className='sidenav-btn' onClick={() => {router('/dashboard/personal'); setIsMobile(false)}}>
                    <span
                        style={{
                    ...
                    <button className='sidenav-btn' onClick={() => {router('/dashboard/work'); setIsMobile(false)}}>
                    <span
                        style={{
